...
public class Evaluate {
	...
	public static void main(String[] args)  {
		...
		evaluateLevels(masterSeed, LevelConfig.LEVEL_0_FLAT, LevelConfig.LEVEL_1_JUMPING, LevelConfig.LEVEL_2_GOOMBAS,   LevelConfig.LEVEL_3_TUBES, LevelConfig.LEVEL_4_SPIKIES);
